...
VOLUME ["/opt/wildfly/standalone/configuration", "/opt/wildfly/standalone/deployments", "/opt/wildfly/standalone/tmp", "/opt/wildfly/standalone/data", "/opt/wildfly/standalone/logs"]
